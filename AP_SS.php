<html>
 <head>
  ...
  <title>appeared shortlisted search</title>  
 ...
 <body>
  <div class="container">
   ...
   <br />
   <br />
   <h2 class="font-weight-bold" style="font-size: 35px; text-align: center;">Search </h2><br />
   ...
   <div class="table-responsive">
    ...
    <table class="table table-bordered table-striped">
     <thead>
      <tr>
       <th>Company Name</th>
       <th>Appeared in Written Test</th>
       <th>Shortlisted Students for Interview</th>
      </tr>
     </thead>
     <tbody>
     </tbody>
   ...
   success:function(data)
   {
    ...
    if(data.length > 0)
    {
     for(var count = 0; count < data.length; count++)
     {
      ...
      html += '<td>'+data[count].Ap_WrittenTest+'</td>';
