<html>
 <head>
  ...
  <title>Group Discussion Search</title>  
 ...
 <body>
  <div class="container">
   ...
   <br />
   <br />
   <h2 class="font-weight-bold" style="font-size: 35px; text-align: center;">Search Grop Discussion</h2><br />
