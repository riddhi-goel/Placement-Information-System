<html>
 <head>
  ...
  <title>Result Date Search</title>  
 ...
 <body>
  <div class="container">
   ...
   <br />
   <br />
   <h2 class="font-weight-bold" style="font-size: 35px; text-align: center;">Search Result Date of Companies</h2><br />
   ...
   success:function(data)
   {
    ...
    if(data.length > 0)
    {
     for(var count = 0; count < data.length; count++)
     {
      ...
      html += '<td>'+data[count].Result_Date+'</td></tr>';
     }
    }
    else
    {
