<html>
 <head>
  ...
  <title>Interviewt Date Search</title>  
 ...
 <body>
  <div class="container">
   ...
   <br />
   <br />
   <h2 class="font-weight-bold" style="font-size: 35px; text-align: center;">Search Interview Date of Companies</h2><br />
   ...
   success:function(data)
   {
    ...
    if(data.length > 0)
    {
     for(var count = 0; count < data.length; count++)
     {
      ...
      html += '<td>'+data[count].Interview_E_Date+'</td>';
      html += '<td>'+data[count].Interview_E_Date+'</td></tr>';
     }
    }
    else
    {
