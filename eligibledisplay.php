...
<div style="margin-top:-4%; margin-left:-18%; font-size:-30%; color: black;">
    <button class="btn btn-dark my-5"><a href="eligibleinsert.php" class="text-light">ADD ELIGIBLE STUDENTS DETAILS</a></button>
  ...
  if($result){
      while($row=mysqli_fetch_assoc($result)){
        ...
        <td>'.$SS_INTERVIEW.'</td>
        <td>
  <button class="btn btn-dark"><a href="eligibleeditt.php?editcompanyname='.$CNAME.'" class="text-light">EDIT</a></button>
  <button input type="submit" class="btn btn-danger" value="DELETE" class="eligibledelete" onclick = "return checkdelete()""><a href="eligibledelete.php?deletecompanyname='.$CNAME.'" class="text-light">DELETE</a></button>
</td>
      </tr>';
      }
  }
