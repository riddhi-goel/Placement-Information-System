<html>
 ...
 <body>
  <div class="container">
   ...
   <br />
   <br />
   <h2 class="font-weight-bold" style="font-size: 35px; text-align: center;">Search Full Time Employment Details</h2><br />
